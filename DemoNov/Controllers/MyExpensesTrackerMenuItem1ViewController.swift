//
//  MyExpensesTrackerMenuItem1ViewController.swift
//  DemoNov
//
...
class MyExpensesTrackerMenuItem1ViewController: TableViewController<CategoriesDSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("MyExpensesTrackerMenuItem1")
       
	    navigationItem.title = NSLocalizedString("My Expenses Tracker", comment: "")
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = MyExpensesTrackerMenuItem1DetailViewController()
...
extension MyExpensesTrackerMenuItem1ViewController: DataResponse {

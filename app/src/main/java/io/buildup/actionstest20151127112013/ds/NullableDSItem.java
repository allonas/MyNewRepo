...
public class NullableDSItem implements Parcelable, IdentifiableBean {
    ...
    public static final Creator<NullableDSItem> CREATOR = new Creator<NullableDSItem>() {
        @Override
        public NullableDSItem createFromParcel(Parcel in) {
            NullableDSItem item = new NullableDSItem();
        ...
        @Override
        public NullableDSItem[] newArray(int size) {
            return new NullableDSItem[size];
        }
    };

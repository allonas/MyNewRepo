//
//  ActionsNotNullableListDetailViewController.m
//  ActionsAppTest
//
...
@interface ActionsNotNullableListDetailViewController ()
...
@implementation ActionsNotNullableListDetailViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROSingleDataLoader alloc] initWithDatasource:(NSObject<RODatasource> *)[[DatasourceManager sharedInstance] notNullableDS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ActionsNotNullableListDetail"];
...
- (void)loadDataSuccess:(NotNullableDSItem *)item {

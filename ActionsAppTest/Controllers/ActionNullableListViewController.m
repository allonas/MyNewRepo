//
//  ActionNullableListViewController.m
//  ActionsAppTest
//
...
#import "ActionNullableListViewController.h"
...
@interface ActionNullableListViewController ()
...
@implementation ActionNullableListViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROListDataLoader alloc] initWithDatasource:[[DatasourceManager sharedInstance] nullableDS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ActionNullableList"];

    self.navigationItem.title = NSLocalizedString(@"ActionNullableList", nil);
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    NullableDSItem *item = self.items[(NSUInteger)indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NullableDSItem *item = self.items[(NSUInteger)indexPath.row];
    ActionNullableListDetailViewController *destinationViewController = [ActionNullableListDetailViewController new];

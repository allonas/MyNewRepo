...
- (void)viewDidLoad {
    ...
    self.items = @[                       
                       [[ROItemCell alloc] initWithText1:@"ActionNullableList"
                                         atImageResource:@"DefaultMenuIcon.png"
                                                atAction:[[ROSlidingAction alloc] initWithRootViewController:self destinationValue:[ActionNullableListViewController class]]],
                       [[ROItemCell alloc] initWithText1:@"ActionsNotNullableList"
                                         atImageResource:@"DefaultMenuIcon.png"
                                                atAction:[[ROSlidingAction alloc] initWithRootViewController:self destinationValue:[ActionsNotNullableListViewController class]]]
                  ];

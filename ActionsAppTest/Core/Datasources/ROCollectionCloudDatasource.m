...
@import NSUserDefaults_AESEncryptor;
...
- (void)load:(id)identifier onSuccess:(RODatasourceSuccessBlock)successBlock onFailure:(RODatasourceErrorBlock)failureBlock {
    ...
    NSString *path = [self.dsId stringByAppendingPathComponent:identifier];
...
- (NSString *)allFilters:(ROOptionsFilter *)optionsFilter {
    ...
    NSMutableArray *query = [NSMutableArray arrayWithArray:optionsFilter.designFilters];
...
- (void)distinctValues:(NSString *)columnName filters:(NSArray *)filters onSuccess:(RODatasourceSuccessBlock)successBlock onFailure:(RODatasourceErrorBlock)failureBlock {
    ...
    optionsFilter.designFilters = [NSMutableArray arrayWithArray:filters];

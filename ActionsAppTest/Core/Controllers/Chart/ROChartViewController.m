...
- (void)viewDidLoad {
    ...
    NSDictionary *viewsBindings = @{
                                    ...
                                    @"topView": self.topLayoutGuide,
                                    @"bottomView": self.bottomLayoutGuide
                                    };
    
    // align tableView from the left and right
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[chartView]|"
                                                                      options:0
                                                                      metrics:nil
                                                                        views:viewsBindings]];
    
    // align tableView from the top and bottom
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[topView][chartView][bottomView]|"
                                                                      options:0
                                                                      metrics:nil
                                                                        views:viewsBindings]];

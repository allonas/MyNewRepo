...
- (NSString *)identifier {
    ...
    if (!_identifier && [[self.viewController item] conformsToProtocol:@protocol(ROModelDelegate)]) {
        
        id <ROModelDelegate> item = (id<ROModelDelegate>)[self.viewController item];

...
@implementation NullableDS

static NSString *const kUrl             = @"https://baked-devel-ibm.herokuapp.com";
static NSString *const kApiKey          = @"NJz48WKn";
static NSString *const kResourceId      = @"/app/56bc883d228cdc0300318742/r/nullableDS";
...
- (instancetype)init {
    ...
    self = [super initWithUrlString:kUrl 
                       ...
                       objectsClass:[NullableDSItem class]];
    if (self) {
...
- (NSArray *)searchableFields {
    ...
    return @[kNullableDSItemPhone, kNullableDSItemUrl, kNullableDSItemEmail, kNullableDSItemId];
}
